...
const char * const BITCOIN_CONF_FILENAME = "lesmicoin.conf";
const char * const BITCOIN_PID_FILENAME = "lesmicoin.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Lesmicoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Lesmicoin";
#else
    // Unix
    return pathRet / ".lesmicoin";
#endif
#endif
}
